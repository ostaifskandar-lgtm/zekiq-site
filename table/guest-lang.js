...
(function (global) {
  var PACK = {
    ar: {
      ...
      errSession: "انتهت الـ15 دقيقة",
      errSessionD: "امسح رمز الطاولة من جديد للطلب.",
      errShopClosed: "المحل مغلق الآن",
      errShopClosedD: "امسح رمز الطاولة بعد الافتتاح",
      errShopClosedAt: "يفتح الساعة {t}",
      errOldQr: "QR قديم",
    ...
    tr: {
      ...
      errSession: "15 dakika doldu",
      errSessionD: "Sipariş için masadaki QR kodu yeniden okutun.",
      errShopClosed: "Dükkân şu an kapalı",
      errShopClosedD: "Açılıştan sonra masadaki QR’ı okutun",
      errShopClosedAt: "Açılış saati {t}",
      errOldQr: "Eski QR",
    ...
    en: {
      ...
      errSession: "15 minutes ended",
      errSessionD: "Scan the table QR again to order.",
      errShopClosed: "The shop is closed now",
      errShopClosedD: "Scan the table QR after opening time",
      errShopClosedAt: "Opens at {t}",
      errOldQr: "Old QR",

...
(function (global) {
  var PACK = {
    ar: {
      ...
      coachTitle: "كيف تطلب؟",
      coach1: 'تصفّح <strong>المينو</strong> — اسحب من الشريط فوق الصورة أو أزرار <strong>السابق / التالي</strong>',
    ...
    tr: {
      ...
      coach1: '<strong>Menüde</strong> gezinin — resmin üstündeki şeridi kaydırın veya altta <strong>Önceki / Sonraki</strong>',
    ...
    en: {
      ...
      coach1: 'Browse the <strong>menu</strong> — swipe the bar above the image or use <strong>Prev / Next</strong>',

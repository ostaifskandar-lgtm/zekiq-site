...
(function (global) {
  var PACK = {
    ar: {
      ...
      coach4: 'في السلة يمكنك كتابة <strong>ملاحظة واضحة</strong> تحت كل صنف قبل الإرسال',
      coachOk: "فهمت — ابدأ الطلب ✓",
      coverStartBadge: "بداية المينو",
      coverStartTitle: "مرحباً",
      coverStartSub: "اسحب للداخل لبدء تصفّح الأطباق",
    ...
    tr: {
      ...
      coverStartBadge: "Menü başı",
      coverStartTitle: "Hoş geldiniz",
      coverStartSub: "Yemekleri görmek için kaydırın",
    ...
    en: {
      ...
      coverStartBadge: "Menu start",
      coverStartTitle: "Welcome",
      coverStartSub: "Swipe to browse dishes",

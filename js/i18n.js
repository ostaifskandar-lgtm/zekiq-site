...
(function (global) {
  ...
  var T = {
    en: {
      ...
      phone_fix_5: "Note the cashier IP from Settings and retry the link",
    ...
    tr: {
      ...
      phone_fix_5: "Ayarlar'daki kasa IP'sini not edip linki tekrar deneyin",
    ...
    ar: {
      ...
      phone_fix_5: "دوّن IP الكاشير من الإعدادات وأعد فتح الرابط",
